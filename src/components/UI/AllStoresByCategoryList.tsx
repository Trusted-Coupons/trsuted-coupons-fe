...
const AllStoresByCategoryList: FC<StoresListProps> = ({ storesByCategory, storeHeading }) => {
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="grid grid-cols-4 gap-4">
        {storesByCategory.map((store: any, index: number) => (
          <Link
...
export default AllStoresByCategoryList;
